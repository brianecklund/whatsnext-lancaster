...
export const testEvents: EventLite[] = [...featuredPartnerEvents, ...extraWeekEvents, ...followingWeekEvents];

export const testUpdates: UpdateLite[] = [
  {
    id: 'test-update-1',
    title: 'Test data note',
    summary: 'Staging-only seeded content is active for the weeks of Mar 29–Apr 4 and Apr 5–Apr 11.',
    date: 'Mar 25, 2026',
    sortDate: '2026-03-25',
    tags: [TEST_DATA_TAG, 'announcement'],
    body: 'This is seeded update content to make it easier to confirm that weekly overview announcement linking still behaves as expected across two heavily populated test weeks. Remove items tagged WNL_TEST_DATA_2026_03 when real content is ready.',
    link: null,
    pinned: true,
  },
];
